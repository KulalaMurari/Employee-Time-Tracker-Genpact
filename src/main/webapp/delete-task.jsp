...
<%@ page import="com.time_tracker.dao.TaskDAO" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        if (request.getParameter("getTasks") != null) {
            ...
            ResultSet rs = TaskDAO.getTasksByDate(currentDate);
            if (rs != null) {
        %>
        <table>
            <thead>
        ...
        <% 
                ...
                out.println("<p>No tasks found for today.</p>");
            }
        }
        %>
        ...
        if (request.getParameter("deleteTaskById") != null) {
            ...
            if (task_id != null && !task_id.isEmpty()) {
                ResultSet rs = TaskDAO.getTaskById(task_id, java.time.LocalDate.now().toString());
                if (rs != null && rs.next()) {
        %>
        <table>
            <thead>
